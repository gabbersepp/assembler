...
Änderung bei BielOS v0.63.01:
3 neue Befehle:
kill <ID>
tasks
tsr <ID>

TSR bedeutet Terminate and Stay Resisdent und bedeutet, dass ein Programm im Speicher bleibt.
Ich erweitere den Begriff und definiere es zusätrzlich als ein Programm, dass 18,2 mal pro Sekunde aufgerufen wird.
Im Moment bietet sich für diesen Befehl noch keine sinnvolle Anwendung, es kommt aber noch.




Änderungen im BielOS v0.63:
